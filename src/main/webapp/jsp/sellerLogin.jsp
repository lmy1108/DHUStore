...
<div class="templatemo-content-widget templatemo-login-widget white-bg">
    ...
    <form action="${pageContext.request.contextPath}/sellerConfirmLogin" class="templatemo-login-form" method="post">
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>
                <input type="text" class="form-control" placeholder="用户名" name="sellerName">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
