...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/validateSeller.js"></script>
</head>
...
<div id="main" class="container">
    ...
    <div class="login">
        <div class="row">
            <div  class="col-md-6">
                <h2 class="text-center">欢迎您，新的卖家</h2>
            ...
            <div class="col-md-5 form-register">
                <div>
                    ...
                    <form class="form-horizontal" id="form" action="${pageContext.request.contextPath}/SellerRegisterResult"
                          method="post">
                        <div class="form-group">
                            <!-- <label for="inputName" class="col-sm-2 control-label">昵称</label> -->
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="sellername"
                                       name="sellername" placeholder="昵称">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                       id="realname" name="realname" placeholder="真实姓名">
                            </div>
                        </div>
                        <div class="form-group">
