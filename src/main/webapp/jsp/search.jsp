                    ...
                    <ul>
                        <c:forEach items="${pageInfo.list}" var="goods">
                            <li class="data-item-li">
                                <div class="to-big">
                                    <a href="${pageContext.request.contextPath}/detail?productid=${goods.productid}"> <img src="/upload/${goods.imagepath}" width="260px" height="260px" alt=""/>
                                    </a>
                                </div>
                                <p class="text-right">
