            ...
            <div class="layui-container">
                <div class="layui-row" id="searchWrapper">
                    <div class="demoTable">
                        ...
                        <div class="layui-inline">
                            <label class="layui-label">用户邮箱</label>
                            <div class="layui-input-inline">
                                <input type="text" name="userEmail" placeholder="请输入用户邮箱" autocomplete="off"
                                       class="layui-input" >
                            </div>
                            <label class="layui-label">用户电话</label>
                            <div class="layui-input-inline">
                                <input type="text" name="userPhone" placeholder="请输入用户电话" autocomplete="off"
                                       class="layui-input" >
                            </div>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-md9">
                        ...
                        <table class="layui-table" lay-data="{width: 900, height:800, url:'/demo2/userjson', id:'testReload'}" lay-filter="demo">
                            <thead>
                            <tr>
                                <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                                <th lay-data="{field:'userid', width:80, sort: true, fixed: true}">用户ID</th>
                                <th lay-data="{field:'username', width:120}">用户名</th>
                                <th lay-data="{field:'password', width:120, sort: true}">密码</th>
                                <th lay-data="{field:'regtime', width:120}">注册时间</th>
                                <th lay-data="{field:'email', width:140}">邮箱</th>
                                <th lay-data="{field:'telephone', width:120, sort: true}">电话</th>
