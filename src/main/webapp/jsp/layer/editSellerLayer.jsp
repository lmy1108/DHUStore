...
<br/>
<br/>
    <form id="updateSeller" class="layui-form" >

        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">卖家编号</label>
                <div class="layui-input-inline">
                    <input value = ${sellerid} type="text" name="sellerid" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">卖家名称</label>
                <div class="layui-input-inline">
                    <input  value="${sellername}" type="text" name="sellername" lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">卖家密码</label>
            <div class="layui-input-inline">
