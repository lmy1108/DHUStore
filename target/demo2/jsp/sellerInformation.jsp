...
<div class="layui-container">
    <div class="layui-row">
        ...
        <div class="layui-col-md4 layui-col-sm6 layui-col-xs12 layui-col-md-offset1">
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-user fa-fw"></i>用户名：${sellerInfo.sellername}<span class="info" id="username"></span>
            </blockquote>
            ...
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-male fa-fw"></i>姓名：${sellerInfo.realname}<span class="info" id="userRealName"></span>
            </blockquote>
            ...
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-phone fa-fw"></i>手机号：${sellerInfo.telephone}<span class="info" id="userTel"></span>
            </blockquote>
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-envelope fa-fw"></i>邮箱：${sellerInfo.email}<span class="info" id="userEmail"></span></blockquote>
            <%--<blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-qq fa-fw"></i>Q Q：<span class="info" id="userQq"></span>--%>
            </blockquote>
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-wechat fa-fw"></i>微信：${sellerInfo.wechat}<span class="info" id="userWechat"></span>
            </blockquote>
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-credit-card fa-fw"></i>支付宝：${sellerInfo.alipay}<span class="info" id="userAlipay"></span></blockquote>
        </div>
        <div class="layui-col-md3 layui-col-sm5 layui-col-xs12 layui-col-md-offset1 layui-col-sm-offset1">
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-calendar fa-fw"></i>注册日期：${sellerInfo.regtime}<span class="info" id="userCredate"></span></blockquote>
            ...
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-cart-arrow-down fa-fw"></i>售出商品：${sellerInfo.sellerAmount}<span class="info" id="sellNum"></span></blockquote>
            <blockquote class="layui-elem-quote layui-quote-nm"><i class="fa fa-rmb fa-fw"></i>售出总额：${sellerInfo.sellerPrice}<span class="info" id="sellMoney"></span><span class="info">元</span></blockquote>
...
<script>
    alert(JSON.stringify(${sellerInfo}));
</script>
