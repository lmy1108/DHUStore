            ...
            <div class="layui-container">
                    ...
                    <div class="demoTable">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="userId" placeholder="请输入评论用户ID" autocomplete="off"
                                       class="layui-input" >
                            </div>
                            <label class="layui-label">商品ID</label>
                            <div class="layui-input-inline">
                                <input type="text" name="productId" placeholder="请输入评论商品ID" autocomplete="off"
                                       class="layui-input">
                            </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <label class="layui-label">评论内容</label>
                            <div class="layui-input-inline">
                                <input type="text" name="content" placeholder="搜索评论内容" autocomplete="off"
                                       class="layui-input" >
                            </div>

                        </div>
                        <div class="layui-inline">
                            <label class="layui-label">起始时间</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" id='test5' name="minTime" placeholder="yyyy-MM-dd HH:mm:ss">
                            </div>
                            <label class="layui-label">结束时间</label>
                            <div class="layui-input-inline">
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-md9">
                        ...
                        <table class="layui-table" lay-data="{width: 900, height:800, url:'/demo2/commentjson', id:'testReload'}" lay-filter="demo">
                            <thead>
                            <tr>
                                <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                                <th lay-data="{field:'commentid', width:80, sort: true, fixed: true}">评论ID</th>
                                <th lay-data="{field:'userid', width:120}">评论用户号</th>
                                <th lay-data="{field:'productid', width:120, sort: true}">评论商品号</th>
                                <th lay-data="{field:'point', width:120}">频评分</th>
                                <th lay-data="{field:'content', width:140}">内容</th>
                                <th lay-data="{field:'commenttime', width:120, sort: true}">评论时间</th>
