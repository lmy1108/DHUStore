    ...
    <div class="layui-container">
        <div class="layui-row">
            ...
            <div class="layui-col-sm9 layui-col-xs12">
                <form class="layui-form" action="/demo2/confirmEditInfo">
                    <div class="layui-form-item">
                        <div class="layui-inline">

                            <label class="layui-form-label"><i class="fa fa-user fa-fw"></i>用户名</label>
                            <div class="layui-input-inline">
                                <input value="${user.username}" type="text" id="username" name="username" placeholder="请输入用户名" class="layui-input" >
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input value="${user.password}" type="password" id="userPassword" name="password" placeholder="请在登录界面进行修改" class="layui-input" >
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input value="${user.realname}" type="text" id="userRealName" name="realname" required="" lay-verify="required" placeholder="请输入真实姓名（必填）" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input value="${user.email}" type="text" id="userEmail" name="email" required="" lay-verify="required|email" placeholder="请输入常用邮箱（必填）" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input value="${user.telephone}" type="text" id="userTel" name="telephone" required="" lay-verify="required|phone" placeholder="请输入常用手机（必填）" class="layui-input">
                            </div>
                        </div>
                        <%--<div class="layui-form-item">--%>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input value='${user.wechat}' type="text" id="userWechat" name="wechat" placeholder="请输入常用微信" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input value="${user.alipay}" type="text" id="userAlipay" name="alipay" placeholder="请输入常用支付宝（必填）" lay-verify="required|number" class="layui-input">
                        </div>
                    </div>
...
<![endif]-->
<script type="text/javascript" src="js/setUserInfo.js"></script>
